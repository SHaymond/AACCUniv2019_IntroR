...
## Pulling the Strings  
### Manipulating data with grep(), gsub() and regular expressions
...
## SOLUTION ##
# Here's something we can work with. Now we have a running mean, sd, and 
# CV for the 7 days of QC for all levels of QC and from each site, 
# down to the analyzer.
num.qcdata %>%
...
qc.table <- filter(num.qcdata, Test == "ALB" & QC_Mnemonic == "CBLIQ1" & Result_Date >= "2018-06-03" & Result_Date < "2018-06-04")
